...
public partial class TelaInicial : ContentPage
{
    ...
    private void Reload()
    {
        ...
        double income = items.Where(a => a.Type == Model.TransacaoType.Income).Sum(a => a.Value);
        double expense = items.Where(a => a.Type == Model.TransacaoType.Expenses).Sum(a => a.Value);
